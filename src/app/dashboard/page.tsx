  ...
  return (
    <div className="min-h-screen bg-black text-white relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 md:gap-0 mb-8 md:mb-12">
          <div className="flex-1">
            <div className="inline-flex items-center px-4 py-2 md:px-6 md:py-3 bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 border border-gray-500/50 rounded-full mb-3 md:mb-4 shadow-2xl backdrop-blur-sm">
              <div className="w-2 h-2 md:w-2.5 md:h-2.5 bg-gradient-to-r from-white to-gray-300 rounded-full mr-2 md:mr-3 animate-pulse"></div>
              <span className="text-white text-[10px] md:text-xs font-bold tracking-[0.22em] uppercase">DASHBOARD</span>
              <div className="w-2 h-2 md:w-2.5 md:h-2.5 bg-gradient-to-r from-gray-300 to-white rounded-full ml-2 md:ml-3 animate-pulse"></div>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight bg-gradient-to-r from-white via-gray-200 to-white bg-clip-text text-transparent">
              Your Learning Hub
            </h1>
          </div>
          <button
            onClick={async () => { await signOut(); router.push('/login'); }}
            className="w-full md:w-auto px-6 py-3 md:py-3 bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 border border-gray-600/50 hover:border-gray-500/70 text-white/90 hover:text-white rounded-xl md:rounded-2xl font-semibold text-sm md:text-base transition-all duration-300 transform hover:scale-105 shadow-xl min-h-[44px]"
          >
            Sign Out
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 md:mb-12">
          <div className="group bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-600/50 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl hover:border-gray-500/70 transition-all duration-700 hover:transform hover:scale-105">
            <div className="text-4xl md:text-5xl font-black text-white mb-2 md:mb-3 bg-gradient-to-r from-white via-gray-200 to-white bg-clip-text text-transparent">
              {totalEnrolled}
            </div>
            <div className="text-gray-300 text-base md:text-lg font-medium tracking-wide">Total Courses</div>
            <div className="mt-3 md:mt-4 w-12 md:w-16 h-1 bg-gradient-to-r from-white via-gray-300 to-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          </div>
          <div className="group bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-600/50 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl hover:border-gray-500/70 transition-all duration-700 hover:transform hover:scale-105">
            <div className="text-4xl md:text-5xl font-black text-white mb-2 md:mb-3 bg-gradient-to-r from-white via-gray-200 to-white bg-clip-text text-transparent">
              {inProgress}
            </div>
            <div className="text-gray-300 text-base md:text-lg font-medium tracking-wide">In Progress</div>
            <div className="mt-3 md:mt-4 w-12 md:w-16 h-1 bg-gradient-to-r from-white via-gray-300 to-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          </div>
          <div className="group bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-600/50 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl hover:border-gray-500/70 transition-all duration-700 hover:transform hover:scale-105 sm:col-span-2 lg:col-span-1">
            <div className="text-4xl md:text-5xl font-black text-white mb-2 md:mb-3 bg-gradient-to-r from-white via-gray-200 to-white bg-clip-text text-transparent">
              {completed}
            </div>
            <div className="text-gray-300 text-base md:text-lg font-medium tracking-wide">Completed</div>
            <div className="mt-3 md:mt-4 w-12 md:w-16 h-1 bg-gradient-to-r from-white via-gray-300 to-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          </div>
        </div>
